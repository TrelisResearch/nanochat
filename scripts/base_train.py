...
while True:
    ...
    # Freeze gate_proj during warmup (lambda_t==0): prevent bias drifting negative before
    # recur has learned anything useful. Once lambda kicks in, gate_proj unfreezes naturally.
    if lambda_t == 0.0:
